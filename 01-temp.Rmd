...
wildfire <- read.csv("/Users/28628890/intro_to_social_data_sci/wildfire/archive/Federal Firefighting Costs (Suppression Only).csv")

temp <- read.csv("/Users/28628890/intro_to_social_data_sci/wildfire/climdiv_national_year.csv")
